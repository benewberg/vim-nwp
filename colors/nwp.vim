...
let s:style = get(g:, 'nwpcolor', 'blacklodge')
let g:colors_name = "nwp"
"}}}
...
let s:palette.regexp    = {'blacklodge': "#6B5A67"}
let s:palette.string    = {'blacklodge': "#47FF52"}
let s:palette.function  = {'blacklodge': "#C77928"}
...
let s:palette.line      = {'blacklodge': "#436176"}
let s:palette.selection = {'blacklodge': "#9C878E"}
let s:palette.fg        = {'blacklodge': "#FFCFA4"}
let s:palette.fg_idle   = {'blacklodge': "#0E3442"}
